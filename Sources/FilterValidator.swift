...
struct FilterValidator {
    ...
    struct Input {
        ...
        let level: SwiftyBeaverClass.Level
        let path: String
        let function: String
        let message: String?
    }
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: SwiftyBeaverClass.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: SwiftyBeaverClass.Level) -> Bool {
