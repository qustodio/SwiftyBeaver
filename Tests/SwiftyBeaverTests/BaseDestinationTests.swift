...
class BaseDestinationTests: XCTestCase {
    ...
    func testMessageToJSON() {
        ...
        XCTAssertEqual(level, SwiftyBeaverClass.Level.info.rawValue)
    ...
    func testLevelWord() {
        ...
        str = obj.levelWord(SwiftyBeaverClass.Level.verbose)
        XCTAssertNotNil(str, "VERBOSE")
        str = obj.levelWord(SwiftyBeaverClass.Level.debug)
        XCTAssertNotNil(str, "DEBUG")
        str = obj.levelWord(SwiftyBeaverClass.Level.info)
        XCTAssertNotNil(str, "INFO")
        str = obj.levelWord(SwiftyBeaverClass.Level.warning)
        XCTAssertNotNil(str, "WARNING")
        str = obj.levelWord(SwiftyBeaverClass.Level.error)
    ...
    func testColorForLevel() {
        ...
        // empty on default
        str = obj.colorForLevel(SwiftyBeaverClass.Level.verbose)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverClass.Level.debug)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverClass.Level.info)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverClass.Level.warning)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverClass.Level.error)
        XCTAssertNotNil(str, "")
    ...
    func test_init_noMinLevelSet() {
        ...
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.verbose, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.error, path: "", function: ""))
    }

    func test_init_minLevelSet() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverClass.Level.info
        XCTAssertFalse(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.verbose, path: "", function: ""))
        XCTAssertFalse(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.error, path: "", function: ""))
    }
    ...
    func test_shouldLevelBeLogged_hasMinLevel_True() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverClass.Level.verbose
        destination.addFilter(Filters.Path.equals("/world/beaver.swift", caseSensitive: true, required: true))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverClass.Level.warning,
    ...
    func test_shouldLevelBeLogged_hasMinLevelAndOneRequiredMessageFilterAndDoesPass_True() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverClass.Level.error
        destination.addFilter(Filters.Message.contains("Required", caseSensitive: false, required: true, minLevel: .info))
